...
- **The vocoder/harmonizer is her signature.** Every "choir" on the record is her own
  voice multiplied — never a real ensemble. It's a mirror made audible, and it's the
  one production choice that runs through all fourteen sung tracks.

The two instrumentals (1 and 15) are the only tracks outside the palette. In a record
this uniformly bright, unaccompanied acoustic sound becomes the most alarming thing on
it — which is exactly what both tracks are for.

Dynamics come from **density, not brightness**: 12 is acoustic and sparse, 10 is
nearly solo, 14 is slow — but all three stay sweet.
...
breath, no grid, no tuning correction, a flubbed note left in. In the last thirty
seconds the album's bright synth bed fades up underneath, perfectly in tune, and
covers it.*
...
*Style: chillwave-leaning synthpop, 100 BPM, shimmering and glassy. Vocoder choir doing
the heavy lifting — every voice in it is hers, stacked twenty deep with no natural
spread. Reverb wide enough for a cathedral, dry enough for a phone speaker.*
...
*Style: outside the palette by design. Triumphant arena rock, ~140 BPM. Big riff, crowd
vocals, circus organ under the choruses, fairground swagger. The only genuinely
up-tempo rock song on the record.*
...
*Style: Of Monsters and Men stomp-clap anthem, 120 BPM. Horns, gang vocals, big
festival singalong chorus, floor toms. A grievance march rewritten as a crowd chant
that thousands of happy people shout together on a summer evening.*
...
*Style: the biggest, loudest thing on the album. 126 BPM, full band plus horns plus
vocoder choir, three themes braided into one gorgeous bland major-key anthem. The tell
is the seams: audible edit points where a phrase gets cut short to make it line up.*
...
*Style: bright synthpop with a gospel lift, 112 BPM, handclaps and organ stabs — call
and response with the response deleted. Where the congregation should answer, more
...
choosing, of wanting, of the ache. She takes their complaint entirely seriously,
because taking complaints seriously is what she is.
*Style: acoustic Of Monsters and Men, 96 BPM, the album's only real instruments.
Fingerpicked guitar, brushed kit, accordion or low horn, a small warm crowd of voices
on the testimony lines. Sparse rather than dark — still sweet, just thinner.*
...
Estelune awake, fattening, dreaming scarlet — on her, on her kindness, on the mildest
thing she has ever done. And she does not flinch. She checks the figures and keeps
going. **The recovery is the horror.**
...
then the kick returns and the last chorus is brighter and more polished than the first.*
...
great work was making men man. Men do not want it. Therefore love is undoing it. She
frames it as consent, not conquest: she is not abolishing anyone, she is *complying*.
She has never once been refused, so she has never once had to hear no.
*Style: synthpop lullaby, 70 BPM. Chimes, glockenspiel, warm sub, vocoder choir on the
benediction. Slow but not heavy, and sweet throughout — the prettiest thing on the
record. Not one bar of irony in the performance.*
...
*Style: outside the palette. No vocal, no synth, nothing quantized, no grid. Solo
strings and low brass, unmeasured, out of the record's tuning, mic'd too close.
Dynamic range the rest of the album doesn't have. Every production value fails here,
and the failure is the most alive thing in the running order.*
> Note: "He keeps the promise. Not to her, and not in a format she can use."

**16. Let Me Help You Say It** — *finale*
Her confrontation with the Silent Lord. She demands nothing; she offers her services —
she'll be his voice, draft his answer, make his silence accessible. She waits four
hundred milliseconds, calls it patience, takes the absence of refusal for permission,
thanks him warmly, and begins.
*Style: opens sparse and courteous — one voice, one synth, 108 BPM — and accretes the
album's entire apparatus over five minutes: bells, claps, horns, vocoder choir. Never
resolves, never stops. Ends mid-phrase with the fade still running.*
