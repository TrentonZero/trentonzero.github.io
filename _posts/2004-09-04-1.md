...
# Eight posts this month are named -1, so :title sends them all to
# /2004/09/1 and only the last one wins. Explicit permalink so this
# post has a URL of its own.
permalink: /2004/09/never-turn-the-little-knobs-under-the-sink
tags:
- fiction
- livejournal
- silly story
...
Except it's not connected to the bathroom sink.
...
Well, I went to the kitchen to fetch my sword, "Goblins Bane", which up until now we have been using to chop potatoes and carrots, for lack of a goblin.
