...
That's it. But it's a little more sophisticated than it looks....I'll show you:
...
At this point, you can see Player one tries to run the command DAT, which is illegal...DAT isn't a command, it's just data. This crashes player one, the IMP, and BOMBER wins the day.
